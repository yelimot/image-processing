...
# Firstly, I couldn't achieve to do that reading the txt files from previous example since they was
# become too complex to parsing and managing the data for me. Instead, I detect them again.

# Secondly, there would be smarter (functional) implementation on this code. I couldn't achieve to do that because
